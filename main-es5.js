...
var ErrorHandle = /** @class */ (function () {
    ...
    /**
      ...
      */
    ErrorHandle.prototype.handleError = function (error) {
        console.log(error);
...
var MbMapComponent = /** @class */ (function () {
    function MbMapComponent(mb, rh) {
        this.mb = mb;
        this.rh = rh;
    ...
    MbMapComponent.prototype.ngOnChanges = function (simp) {
        var _this = this;
        console.log('run it');
        ...
        if (this.data !== undefined &&
            this.data !== null &&
            this.data.length !== 0) {
            var addressObs = this.data.map(function (x) {
                return _this.mb.getLatLong(x.address);
            });
            this.minMaxValue = this.getMinMaxPrice(this.markers);
            Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(addressObs).subscribe(function (res) {
                res.forEach(function (v, i) {
                    if (v.status === 'OK' && v.results) {
                        var mar = _this.mapResultToMarker(v, i);
                        _this.markers.push(mar);
                    }
                });
                _this.restMarker();
    ...
    MbMapComponent.prototype.getLabelOption = function (price) {
        return {
            color: 'black',
            fontFamily: '',
            fontSize: '14px',
    ...
    MbMapComponent.prototype.clickedMap = function (event) {
        if (this.previous) {
            this.previous.close();
            this.previous = undefined;
        }
    };
    MbMapComponent.prototype.clickedMarker = function (label, infoWindow, marker, index) {
        if (this.previous && this.previous !== infoWindow) {
            this.previous.close();
        }
        this.previous = infoWindow;
    };
    MbMapComponent.prototype.mapResultToMarker = function (v, i) {
        var mar = new _marker__WEBPACK_IMPORTED_MODULE_3__["Marker"]();
     ...
     *
     */
    MbMapComponent.prototype.restMarker = function () {
        this.minMaxValue = this.getMinMaxPrice(this.markers);
     ...
     * @param markers
     */
    MbMapComponent.prototype.getMinMaxPrice = function (markers) {
        if (!this.markers || this.markers.length === 0) {
            return this.minMaxValue;
        }
        // convert currency to number and then remove all empty/NaN values
        var priceArray = this.markers
            .map(function (m) { return parseFloat(m.price.replace(/[,$]/g, '')); })
            .filter(function (value) { return !Number.isNaN(value); });
        // find max value
        var max = priceArray.reduce(function (pr, cur) {
            return Math.max(pr, cur);
        });
        // find min value
        var min = priceArray.reduce(function (pr, cur) {
     ...
     *
     */
    MbMapComponent.prototype.ngOnInit = function () {
     ...
     * @param maxPrice
     */
    MbMapComponent.prototype.getOptions = function (maxPrice) {
        return {
            floor: 0,
            ceil: maxPrice,
     ...
     *
     */
    MbMapComponent.prototype.onSliderChanged = function () {
        var _this = this;
        // convert currency to number and then remove all empty/NaN values
        var priceArray = this.markers.map(function (m) {
            return parseFloat(m.price.replace(/[,$]/g, ''));
        });
        // get markers from min and max range
        this.changedMarkers = this.markers.filter(function (v, i) {
            return (priceArray[i] >= _this.minMaxValue[0] &&
                priceArray[i] <= _this.minMaxValue[1]);
        });
    };
    MbMapComponent.ctorParameters = function () { return [
...
var MbTableComponent = /** @class */ (function () {
    function MbTableComponent() {
    }
    MbTableComponent.prototype.ngOnInit = function () {
    };
...
var UrlValidatorDirective = /** @class */ (function () {
    function UrlValidatorDirective() {
    }
    UrlValidatorDirective_1 = UrlValidatorDirective;
    UrlValidatorDirective.prototype.validate = function (control) {
        var reg = 'https://www.kijiji.ca/.*';
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.ks.getCategoryLevel1().subscribe(function (cata) { return (_this.categories = cata); });
    };
    AppComponent.prototype.citySelected = function (event) {
        console.log(event);
        this.selectedCity = this.cityNames.names.find(function (ci) { return ci.citycode === event.value; });
        this.createUrl();
    };
    AppComponent.prototype.createUrl = function (category) {
    ...
    AppComponent.prototype.setupUrl = function () {
    ...
    AppComponent.prototype.priceChanged = function () {
        if (this.minPrice && this.maxPrice && this.needPriceFilter) {
            this.url = this.addFilter("price=" + this.minPrice + "__" + this.maxPrice);
        }
    };
    AppComponent.prototype.addFilter = function (arg0) {
        var va = this.url.includes('?') ? '&' : '?';
        return (this.url = this.url + va + arg0);
    };
    AppComponent.prototype.categoryChanged = function (event) {
        var _this = this;
        if (event.source && event.value) {
            ...
            this.ks.getCategorySubLevels(event.value).subscribe(function (cata) {
                _this.categories = cata;
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.validator = function () { };
    /**
     * get all the list of rented house
     */
    HomeComponent.prototype.getRentedHouses = function () {
        var _this = this;
        this.rh.getItemsInfoByPage({
            ...
            _this.scrapedData = new Array();
            items.forEach(function (element) {
                _this.scrapedData.push(element);
            });
            localStorage.setItem('dataSource', JSON.stringify(_this.scrapedData));
            _this.scrapedData = _this.scrapedData.slice();
            console.log('this.scrapedData', _this.scrapedData);
        });
    };
    /**
     * On button click
     */
    HomeComponent.prototype.DeleteHistoryData = function () {
        localStorage.removeItem('dataSource');
    };
    /**
     * on Button click
     * @param page
     */
    HomeComponent.prototype.GetAllTheItems = function (page) {
        var _this = this;
        console.log('items', page);
        return page.listOfpageUrls.map(function (pageUrl) {
            return _this.rh.getItemsInfoByPage({ url: pageUrl });
        });
    };
...
var CityNamesForOntario = /** @class */ (function () {
    function CityNamesForOntario() {
        this.names = [
...
var KijijiService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](KijijiService, _super);
    function KijijiService(http) {
        var _this = _super.call(this) || this;
        _this.http = http;
        _this.pyScraping = "http://127.0.0.1:5000/";
        return _this;
    }
    KijijiService.prototype.getCategoryLevel1 = function () {
        return this.http
    ...
    KijijiService.prototype.getCategorySubLevels = function (categoryId) {
        return this.http
            .post(this.pyScraping + "getCategories", { categoryId: categoryId })
            .pipe(Object(rxjs_internal_operators_catchError__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    KijijiService.ctorParameters = function () { return [
    ...
    return KijijiService;
}(_Shared_errorHandle__WEBPACK_IMPORTED_MODULE_3__["ErrorHandle"]));
...
var MbMapService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](MbMapService, _super);
    function MbMapService(http) {
        var _this = _super.call(this) || this;
        _this.http = http;
        _this.apiKey = 'AIzaSyC3u1VAIs0S5Ij-HmcxrTEMIx19X8UZH30';
        _this.geocodeUrl = 'https://maps.googleapis.com/maps/api/geocode';
        return _this;
    }
    MbMapService.prototype.getLatLong = function (address, type) {
    ...
    MbMapService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return MbMapService;
}(_Shared_errorHandle__WEBPACK_IMPORTED_MODULE_4__["ErrorHandle"]));
...
var RentedHousesService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](RentedHousesService, _super);
    function RentedHousesService(http) {
        var _this = _super.call(this) || this;
        _this.http = http;
        _this.apiKey = 'AIzaSyC3u1VAIs0S5Ij-HmcxrTEMIx19X8UZH30';
    ...
    RentedHousesService.prototype.getHouses = function (url) {
        return this.http
            .post(this.pyScraping, url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    };
    RentedHousesService.prototype.getPageInfo = function (url) {
        return this.http
            .post(this.getUrl('getTotalPages'), url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    };
    RentedHousesService.prototype.getItemsInfoByPage = function (url) {
        return this.http
            .post(this.getUrl('getItemsInfoByPage'), url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.handleError));
    };
    RentedHousesService.ctorParameters = function () { return [
...
var ServicesModule = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ServicesModule, _super);
...
}(_Shared_errorHandle__WEBPACK_IMPORTED_MODULE_6__["ErrorHandle"]));
